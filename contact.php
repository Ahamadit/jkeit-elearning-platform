...
<section class="verification-section py-5" style="background: #f1f5f9;">
    <div class="container">
        <div class="row justify-content-center align-items-center text-center">
            ...
            <div class="col-lg-8 col-md-10 mb-4">
                <div class="p-4 bg-white rounded-4 shadow-lg">
                    <h2 class="fw-bold mb-3" style="color:#023E8A;">Document Verification Notice</h2>
                    <p class="lead text-dark mb-3">
                        Mail all documents (<strong>Verification Request letter</strong> and
                        <strong>Supporting Documents</strong>) in a single <strong>PDF file</strong> to
                        <a href="mailto:jkeitonline@gmail.com" class="text-primary text-decoration-none fw-semibold">
                            jkeitonline@gmail.com
                        </a>
                        before posting the documents. <br>Please post all documents to the Communication Office address only
                    </p>
            ...
            <div class="col-lg-4 col-md-8">
                <div class="contact-card bg-white shadow-lg rounded-4 p-4 text-start">
                    <h4 class="fw-bold text-primary mb-3 text-center">Contact Us</h4>
                    <ul class="list-unstyled text-dark">
                        <li class="mb-3 d-flex align-items-center">
                            <i class="bi bi-envelope-fill text-primary me-2 fs-5"></i>
                            <a href="mailto:jkeitonline@gmail.com"
                                class="text-decoration-none text-dark">jkeitonline@gmail.com</a>
                        </li>
                        <li class="mb-3 d-flex align-items-center">
                            <i class="bi bi-telephone-fill text-primary me-2 fs-5"></i>
                            <a href="tel:+919634599903"
                                class="text-decoration-none text-dark">+91 9634599903</a>
                        </li>
                        <li class="mb-3 d-flex align-items-center">
                            <i class="bi bi-geo-alt-fill text-primary me-2 fs-5"></i>
                            <a href="https://www.google.com/maps/search/Mathura,+Uttar+Pradesh+281004"
                        ...
                        <li class="d-flex align-items-center">
                            ...
                            <a href="https://jkeit.in" target="_blank"
                                class="text-decoration-none fw-semibold text-primary">Jkeit.in</a>
                        </li>
                    </ul>
                </div>
            </div>
