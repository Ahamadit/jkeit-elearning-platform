...
$subjects = [];
$stmt2 = $conn->prepare("SELECT subject_name FROM add_subject WHERE course_id = ? ORDER BY id ASC");
  ...
  <div class="flex pt-16">
    ...
    <aside class="w-64 bg-gradient-to-b from-blue-600 to-blue-800 text-white h-screen p-5 fixed">
      <ul class="space-y-4">
        ...
        <li><a href="id-card.php" class="flex items-center space-x-3 hover:bg-blue-500 p-2 rounded-lg cursor-pointer"><i data-feather="credit-card"></i><span>ID Card</span></a></li>
    ...
    <main class="ml-64 flex-1 p-8">
      <h1 class="text-2xl font-bold mb-6">Syllabus / Subjects for <?php echo htmlspecialchars($courseName); ?></h1>
            ...
            <tbody>
              ...
              <?php foreach ($subjects as $subject): ?>
                <tr class="border-b hover:bg-gray-100">
                  ...
                  <td class="py-3 px-4 font-medium text-gray-700"><?php echo htmlspecialchars($subject); ?></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
