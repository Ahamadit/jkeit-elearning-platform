...
<head>
    ...
    <title>JKEIT Admin - Prospects</title>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header flex-wrap">
                        <div class="d-flex">
                            <a href="add_prospects.php" class="btn btn-sm btn-success ml-3"><i class="mdi mdi-plus"></i> Add Prospects</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">All Prospects</h4>
                                                    ...
                                                    while ($row = $result->fetch_assoc()) {
                                                     ...
                                                     <td data-label='Actions'>
                                                      <div class='d-flex justify-content-center gap-1'>
                                                          <a href='edit_prospects.php?id={$row['id']}' class='btn btn-sm btn-primary'>
                                                             <i class='mdi mdi-pencil'></i>
                                                          </a>   
                                                         <a href='delete_prospects.php?id={$row['id']}' class='btn btn-sm btn-danger delete-btn'   data-id='{$row['id']}'>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.delete-btn').forEach(link => {
                link.addEventListener('click', function(e) {
                    ...
                    Swal.fire({
                        title: 'Are you sure?',
                        text: "This prospect will be permanently deleted!",
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            window.location.href = `delete_prospects.php?id=${id}`;
                        }
                    });
                });
            });
