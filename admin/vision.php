...
<head>
    ...
    <title>JKEIT Admin - Vision</title>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="page-header flex-wrap mb-3">
                        <div class="d-flex">
                            <a href="add_vision.php" class="btn btn-success"><i class="mdi mdi-plus"></i> Add Vision</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">All Vision</h4>
                                            ...
                                            <tbody>
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        $imagePath = "uploads/vision/" . $imageFile;

                                                        if (!empty($imageFile) && file_exists(__DIR__ . "/uploads/vision/" . $imageFile)) {
                                                        ...
                                                        echo "<tr>
                                                                ...
                                                                <td>
                                                                    <a href='edit_vision.php?id={$row['id']}' class='btn btn-primary'><i class='mdi mdi-pencil'></i></a>
    ...
    <script>
        ...
        document.querySelectorAll('.delete-btn').forEach(btn => {
            btn.addEventListener('click', function(e) {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "This vision entry will be permanently deleted!",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "delete_vision.php?id=" + id;
                    }
                });
            });
        });
