      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header flex-wrap">
            <h3 class="mb-0">Governing Council - JKEIT</h3>
            <div class="d-flex">
              <a href="add_governing.php" class="btn btn-sm btn-success ml-3"><i class="mdi mdi-plus"></i> Add Governing Council </a>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card shadow-sm">
                <div class="card-body">
                  <h4 class="card-title mb-4">All Governing Council - JKEIT</h4>
                          ...
                          <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            <tr>
                              ...
                              <td data-label="Actions">
                                <a href="edit_governing.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-primary"><i class="mdi mdi-pencil"></i></a>
                                <a href="delete_governing.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-danger delete-btn"><i class="mdi mdi-delete"></i></a>
                              </td>
                            </tr>
                          <?php endwhile; ?>
                        <?php else: ?>
  ...
  <script>
    ...
    document.querySelectorAll('.delete-btn').forEach(btn => {
      btn.addEventListener('click', function(e) {
        ...
        Swal.fire({
          title: 'Are you sure?',
          text: "This governing council will be permanently deleted!",
          icon: 'warning',
