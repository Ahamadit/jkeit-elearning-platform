<?php
include __DIR__ . '/../database.php'; // adjust path if database.php is outside admin
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header flex-wrap">
            ...
            <div class="d-flex">
              <a href="add_course.php" class="btn btn-sm btn-success ml-3"><i class="mdi mdi-plus"></i> Add New Course</a>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card shadow-sm">
                <div class="card-body">
                  <h4 class="card-title mb-4">All Courses</h4>
                ...
                <td data-label='Image'><img src='uploads/{$row['image']}' alt='Course Image' style='width:60px;height:auto;'></td>
                <td data-label='Course Name'>{$row['course_name']}</td>
                <td data-label='Subject'>{$row['subject']}</td>
                <td data-label='Price'>₹{$row['price']}</td>
                <td data-label='Duration'>{$row['duration']}</td> <!-- Display duration -->
                <td data-label='Actions'>
                  <div class='d-flex justify-content-center gap-1'>
                    <a href='course_edit.php?id={$row['id']}' class='btn btn-sm btn-primary'><i class='mdi mdi-pencil'></i></a>
                    <a href='course_delete.php?id={$row['id']}' class='btn btn-sm btn-danger delete-btn'><i class='mdi mdi-delete'></i></a>
                  </div>
                </td>
              </tr>";
                            $sr++;
                          ...
                          echo "<tr><td colspan='7' class='text-center text-muted'>No courses found</td></tr>"; // colspan changed to 7
                        }
                        ?>
                      </tbody>
                    </table>
