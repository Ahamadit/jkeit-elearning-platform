...
<head>
    ...
    <style>
        ...
        .table.table-bordered.table-hover.table-striped tbody td img {
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header flex-wrap">
                        <h3 class="mb-0">Logo List</h3>
                        <div class="d-flex">
                            <a href="add_logo.php" class="btn btn-sm btn-success ml-3"><i class="mdi mdi-plus"></i> Add Logo</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">All logo</h4>
                                            ...
                                            <tbody>
                                                ...
                                                if ($result->num_rows > 0) {
                                                    ...
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        echo "<td class='px-4 py-2 border-b'>{$sr_no}</td>";
                                                        echo "<td class='px-4 py-2 border-b'>";
                                                        echo "<img src='uploads/{$row['image']}' alt='Logo' width='100'>";
                                                        echo "</td>";

                                                        // Action buttons
                                                        echo "<td class='px-4 py-2 border-b'>";
                                                        echo "<a href='edit_logo.php?id={$row['id']}' class='btn btn-sm btn-primary'>Edit</a> ";
                                                        echo "<a href='delete_logo.php?id={$row['id']}' class='btn btn-sm btn-danger delete-btn'>Delete</a>";
                                                    ...
                                                    echo "<tr><td colspan='3' class='px-4 py-2 text-center'>No logos found</td></tr>";
                                                }
                                                ?>
                                            </tbody>
                                        </table>
