...
// Fetch all courses
$sql = "SELECT * FROM franchisee_students ORDER BY id DESC";
...
<body>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header flex-wrap">
                        <h3 class="mb-0">All Franchiseer Student Details</h3>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">All Details </h4>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped">
                                            <thead>
                                                <tr>
                                                    <th>SR NO</th>
                                                    <th>Franchiseer name</th>
                                                    <th> Student-Name</th>
                                                    <th>Email</th>
                                                    <th>Password</th>
                                                    <th>Phone</th>
                                            ...
                                            <tbody>
                                                <?php if ($result->num_rows > 0): ?>
                                                    ...
                                                    <?php while ($row = $result->fetch_assoc()): ?>
                                                        <tr>
                                                            <td><?php echo $i++; ?></td>
                                                            <td><?php echo htmlspecialchars($row['franchisee_name']); ?></td>
                                                            ...
                                                            <td>
                                                                <button class="btn btn-sm btn-secondary status-btn" data-id="<?php echo $row['id']; ?>">Status</button>
                                                            </td>
    ...
    <script>
        document.querySelectorAll('.status-btn').forEach(button => {
            ...
            // Check localStorage if this student is active
            if (localStorage.getItem('status_' + id) === 'active') {
