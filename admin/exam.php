...
// Fetch all exams from add_exam table
$sql = "SELECT * FROM add_exam ORDER BY id DESC";
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header flex-wrap">
                        ...
                        <div class="d-flex">
                            <a href="add_exam.php" class="btn btn-sm btn-success ml-3"><i class="mdi mdi-plus"></i> Add Exam</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">All Exams</h4>
                                                    ...
                                                    while ($row = $result->fetch_assoc()) {
                                                        echo "<tr>
                                                                 ...
                                                                 <td>
                                                                   ...
                                                                   <a href='edit_exam.php?id={$row['id']}' class='btn btn-sm btn-primary' title='Edit Exam'>
                                                                   <i class='mdi mdi-pencil'></i>
                                                                   </a>
                                                                  <a href='delete_exam.php?id={$row['id']}' class='btn btn-sm btn-danger delete-btn' title='Delete Exam'>
                                                                  <i class='mdi mdi-delete'></i>
                                                                   </a>
                                                                  </td>
                                                                  <td>
                                                                    <a href='question.php?exam_id={$row['id']}' class='btn btn-sm btn-success' title='Add Question'>
                                                                    <i class='mdi mdi-plus-box'></i> add question
                                                                    </a>
                                                                  </td>
                                                             </tr>";
