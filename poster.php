...
<head>
    ...
    <style>
        ...
        /* this css use for show image */

       .poster-card {
    height: 100%; /* ensures the card fills available height */
...
<div class="poster-section container py-5" data-aos="fade-up" data-aos-delay="100">
    <h3 class="text-center mb-5 fw-bold" style="color:#023E8A;">Our Latest Posters</h3>
    ...
    <div class="row g-4 justify-content-center">
        ...
        if ($result && $result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                if (!empty($imageFile) && file_exists(__DIR__ . '/admin/uploads/' . $imageFile)) {
                    echo "
                    <div class='col-md-6 col-sm-12'>
                        <div class='poster-card shadow-lg rounded-4 overflow-hidden'>
                            <img src='{$imagePath}' alt='Poster' class='poster-img'>
                        </div>
                    </div>";
                }
            }
        } else {
            echo "<div class='text-center text-muted py-4'>No posters available</div>";
        }
        ?>
    </div>
</div>
