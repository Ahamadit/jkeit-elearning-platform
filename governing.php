...
$query = "SELECT * FROM governing ORDER BY id DESC";
...
<body class="index-page">
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            <img src="assets/slider/slider2.avif" alt="JKEIT Governing Council" class="hero-img" data-aos="fade-in">
            <div class="container hero-content text-center">
                <h2 data-aos="fade-up" data-aos-delay="100">GOVERNING COUNCIL - JKEIT</h2>
                <p data-aos="fade-up" data-aos-delay="200">
                    Guiding the institute with wisdom, leadership, and a vision for excellence in education and skill development.
                </p>
            </div>
        </section>

        <!-- Governing Council Section -->
        <section id="council" class="council section py-5 bg-light">
            <div class="container" data-aos="fade-up">

                <!-- Section Title -->
                <div class="section-title text-center mb-5">
                    <h2 class="fw-bold">Our Governing Council</h2>
                    <p class="text-muted">Leaders who shape the future of JKEIT with vision, dedication, and commitment.</p>
                </div>
