    ...
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            ...
            <div class="container hero-content text-center">
                <h2 data-aos="fade-up" data-aos-delay="100">Vision &amp; Mission</h2>
                <p data-aos="fade-up" data-aos-delay="200">
                    To empower students with quality education and practical skills...
                </p>
            </div>
        </section>
        ...
        <section id="vision-mission" class="vision-mission section py-5 bg-light">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title text-center mb-5">
                    <h2 class="fw-bold">Our Vision, Mission & Values</h2>
                    <p class="text-muted">Shaping futures with knowledge, skills, and values at JKEIT</p>
                </div>
                    ...
                    <div class="row gy-4">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                // ✅ Correct browser path for images
                                $imagePath = "admin/uploads/vision/" . $imageFile;

                                // ✅ Show uploaded image or default placeholder
                                if (!empty($imageFile)) {
                                    $imgTag = "<img src='{$imagePath}' alt='Vision Image'>";
                                } else {
                        ...
                        <?php
                            ...
                            echo "<div class='col-12 text-center'><p class='text-muted'>No vision records found.</p></div>";
                        }
                        ?>
                    </div>
                </div>
