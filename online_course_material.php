...
$query = "SELECT * FROM vision ORDER BY id DESC";
...
<body class="index-page">
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            <img src="assets/slider/slider2.avif" alt="Vision and Mission" class="hero-img" data-aos="fade-in">
        ...
        <section id="vision-mission" class="section py-5 bg-light">
            <div class="container" data-aos="fade-up">
                <div class="section-title text-center mb-5">
                    <p class="text-muted text-center">Online Course Materials</p>
                </div>


                <div class="card shadow-sm p-4 rounded-4 mx-auto" style="max-width: 900px; background: #ffffff;">
                    <p class="text-dark mb-3" style="font-size: 1.05rem; line-height: 1.8;">
                        <strong>JAN KALYAN EDUCATIONAL INSTITUTE OF TECHNOLOGY</strong>, as an emerging Autonomous Institute in India, aims to impart top-notch education to its learners with optimum resources, so that they can continue their education seamlessly.
                        JAN KALYAN EDUCATIONAL INSTITUTE OF TECHNOLOGY provides quality course materials online to its learners free of cost. Learners, who want to access online course materials, may follow the step by step procedures given below:
                    </p>

                    <h5 class="fw-bold mt-4">Step-By-Step Procedures to Access the Online Study Materials:</h5>
                    <ol class="mt-3" style="line-height: 1.7;">
                        <li>Click on the <strong>Student Zone</strong> of the website.</li>
                        <li>Students need to enter the required details.</li>
                        <li>After submitting the required details, you will get the <strong>Dashboard</strong>.</li>
                        <li>Click on the <strong>Book</strong> menu to see your subject lists.</li>
                        <li>Click on <strong>View Description</strong> of subjects; your subject book(s) will appear.</li>
                        <li>Download your books/chapters.</li>
                    </ol>
                </div>
            </div>
        </section>
